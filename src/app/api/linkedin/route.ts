...
export async function GET() {
  ...
  try {
    ...
    console.log(
      "[LINKEDIN CHECK] External accounts:",
      JSON.stringify(
    ...
    console.log(
      "[LINKEDIN CHECK] LinkedIn account found:",
      linkedinAccount ? "YES" : "NO"
    );
    if (linkedinAccount) {
      console.log(
        "[LINKEDIN CHECK] LinkedIn provider:",
        linkedinAccount.provider
      );
    }
    ...
    console.error(
      "[LINKEDIN CHECK] Error fetching LinkedIn connection:",
      error
    );
