...
function TabsList({
  ...
  return (
    <TabsPrimitive.List
      className={cn(
        "inline-flex h-9 w-fit items-center justify-center rounded-lg bg-background p-[3px] text-foreground shadow-custom",
        className
      )}
      data-slot="tabs-list"
      {...props}
